...
Epoll::Epoll() : epollFd_(epoll_create1(EPOLL_CLOEXEC)), events_(EVENTSNUM) { assert(epollFd_ > 0); }
Epoll::~Epoll() {}
...
void Epoll::epoll_add(SP_Channel request, int timeout) {
  ...
  request->EqualAndUpdateLastEvents(); // 为了epoll_mod方便
